...
# ---------- Load accounts from Mod-x.txt ----------
def load_accounts():
    accounts = []
    try:
        with open("Mod-x.txt", "r", encoding="utf-8") as f:
            for line in f:
                line = line.strip()
...
<body>
<div class="container">
    <h1>🔥 MOD-X Spam Tool 🔥</h1>
    <div class="credit">⚡ Credit: NTT MOD-X⚡</div>
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <button id="startBtn">▶ Spam shuru karo</button>
        </div>
